...
function RenderPopupOrAddToCart({ data , lang}: { data: Product , lang:string}) {
  ...
  if (product_type === 'variable') {
    return (
      <button
        className="min-w-[150px] min-h-[38px] px-4 py-2 bg-skin-primary rounded-full  text-skin-inverted text-[13px] items-center justify-center focus:outline-none focus-visible:outline-none"
