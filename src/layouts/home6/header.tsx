...
function Header({lang}: { lang: string }) {
    ...
    return (
      <>
        ...
        >
          <div className="innerSticky z-20 w-full transition duration-200 ease-in-out  body-font bg-skin-six">
            <Search
              lang={lang}
            ...
            <div className="hidden navbar lg:block bg-skin-six">
              <Container className={'sm:max-w-[1730px]'}>
                <div className="flex justify-between items-center">
                  ...
                  <div className="categories-header-button relative me-8 flex-shrink-0 w-72">
                    <button
                      className="border-white/10 min-h-[60px] focus:outline-none w-full font-medium text-white uppercase py-4 flex items-center ltr:border-r rtl:border-l"
